    ...
    return (
        <div className='center'>
            ...
            <div className='container'>
                <Card img='./../assets/menu-1.png' title="Delicia del Océano" description="Sumérgete en la frescura del mar con nuestra exquisita selección de sushi. Experimenta sabores inigualables que te transportarán directamente a la costa japonesa."/>
